...
import { createPostReq, updatePostReq } from "./requests";
    ...
    <>
          ...
          <table>
            <thead>
              <tr>
                ...
                />
                <TableTHHeader text="Edit" iconc={null} />
              </tr>
            </thead>
            <tbody>
              {posts.length > 0 ? (
      ...
      >
            ...
            >
              ...
              >
                <CustomizedInputSimple
                  ...
                  placeholder="title"
                  value={updatePost}
                  key={`selectPage?.title:${selectPage?.title}`}
        ...
        <DialogActions>
          ...
          <Button onClick={commitData}>Agree</Button>
        </DialogActions>
      </Dialog>
